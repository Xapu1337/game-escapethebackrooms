...
function LuaModsLoadOrderInfo() {
    return (
        <div style={{paddingLeft: '8px'}}>
            ...
            <p>Lua mods are used to inject changes into the game without requiring a PAK file. <a href='https://www.nexusmods.com/escapethebackrooms/mods/942'>UE4SS</a> must be installed for these mods to work correctly.</p>
        </div>
    );
}
